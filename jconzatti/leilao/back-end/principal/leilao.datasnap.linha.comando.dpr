program leilao.datasnap.linha.comando;
{$APPTYPE CONSOLE}
...
uses
  ...
  UJconzatti.Leilao.Datasnap.MetodoServidor.Exemplo in 'datasnap\metodo-servidor\UJconzatti.Leilao.Datasnap.MetodoServidor.Exemplo.pas',
  UJconzatti.Leilao.Datasnap.ModuloWeb in 'datasnap\modulo-web\UJconzatti.Leilao.Datasnap.ModuloWeb.pas' {ModuloWeb: TWebModule},
  UJconzatti.Leilao.Datasnap.Constante in 'datasnap\UJconzatti.Leilao.Datasnap.Constante.pas';
...
var LServer: TIdHTTPWebBrokerBridge;
    LResponse: string;
begin
   WriteCommands;
...
begin
   try
     if WebRequestHandler <> nil then
         WebRequestHandler.WebModuleClass := ModuloWebClass;
      RunServer(8080);
   except
      on E: Exception do
